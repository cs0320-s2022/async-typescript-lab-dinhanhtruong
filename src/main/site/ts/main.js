...
sun === null || sun === void 0 ? void 0 : sun.addEventListener("change", () => {
    postAndUpdate();
});
moon === null || moon === void 0 ? void 0 : moon.addEventListener("change", () => {
    postAndUpdate();
});
rising === null || rising === void 0 ? void 0 : rising.addEventListener("change", () => {
    postAndUpdate();
});
